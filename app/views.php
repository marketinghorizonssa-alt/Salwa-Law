...
function form_html(array $page): string {
    ...
    $html .= '<label>رقم الجوال<input name="phone" type="tel" inputmode="tel" autocomplete="tel" maxlength="32" required placeholder="مثال: 05xxxxxxxx أو +966…"></label>';
    ...
    $html .= '<label class="consent"><input name="consent" type="checkbox" value="1" checked required><span>أوافق على استخدام بياناتي للرد على طلبي وفق <a href="/سياسة-الخصوصية/" target="_blank" rel="noopener">سياسة الخصوصية</a>.</span></label>';
...
function authority_strip(array $page): string {
    $items = [
        '<a class="authority authority-moj" href="https://www.moj.gov.sa/" target="_blank" rel="noopener"><span class="authority-symbol" aria-hidden="true">⚖</span><span><strong>وزارة العدل</strong><small>الجهة العدلية الرسمية</small></span></a>',
        '<a class="authority authority-sba" href="https://sba.gov.sa/" target="_blank" rel="noopener"><img src="https://sba.gov.sa/wp-content/uploads/2022/03/whitelogo-2.png" width="150" height="94" loading="lazy" alt="شعار الهيئة السعودية للمحامين"><span><strong>الهيئة السعودية للمحامين</strong><small>الجهة المهنية ذات الصلة</small></span></a>'
    ];
    if (($page['id'] ?? '') === 'LP03') {
        $items[] = '<a class="authority authority-hrsd" href="https://www.hrsd.gov.sa/" target="_blank" rel="noopener"><img src="https://www.hrsd.gov.sa/sites/default/files/styles/ckeditor_medium/public/2026-01/arabic-logo.png?itok=lUwoDmrT" width="180" height="90" loading="lazy" alt="شعار وزارة الموارد البشرية والتنمية الاجتماعية"><span><strong>وزارة الموارد البشرية والتنمية الاجتماعية</strong><small>مرجع أنظمة وعلاقات العمل</small></span></a>';
    }
    if (($page['id'] ?? '') === 'LP05') {
        $items[] = '<a class="authority authority-saip" href="https://saip.gov.sa/" target="_blank" rel="noopener"><img src="https://saip.gov.sa/images/saip-logo-color.svg" width="165" height="80" loading="lazy" alt="شعار الهيئة السعودية للملكية الفكرية"><span><strong>الهيئة السعودية للملكية الفكرية</strong><small>الجهة الحكومية المختصة بالملكية الفكرية</small></span></a>';
    }
    return '<section class="authority-band" aria-label="جهات نظامية ذات صلة"><div class="wrap"><div class="authority-head"><span>جهات نظامية ذات صلة</span><small>تُعرض للتعريف بالجهات ذات الصلة بالخدمة ولا تعني شراكة أو اعتمادًا إضافيًا.</small></div><div class="authority-list">'.implode('', $items).'</div></div></section>';
}
